...
What This Is . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
Scope . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 2
Three Ways to Read This. 2
A Note on Evaluation. 3
Where Our Resources Come From. 3
One Last Thing. 3
Part 1: The Landscape 4
Chapter 1: The Language of Generative and Agentic AI 5
1.1 The Raw Material 6
Generative AI 6
Foundation Model 6
Large Language Model (LLM) 7
Tokens 7
Context Window 7
Pretraining, Fine-Tuning, Post-Training 8
1.2 From Text to Thought 9
Chain-of-Thought 9
Reasoning Models 9
Multimodality 10
1.3 Talking to the Model 10
Prompting 10
System Prompt 11
Few-Shot and In-Context Learning 11
Context Engineering 11
1.4 Beyond Single Calls 12
Tool Use and Function Calling 12
Agent 12
Workflow vs Agent 13
Router and Classifier Patterns 13
Specialist and Sub-Agent 14
Multi-Agent System 14

1.5 Knowing What You Don't Know 15  
Retrieval 15  
Semantic Search and Embeddings 15  
Vector Database 15  
Memory 16  
1.6 Keeping It Honest 16  
Evaluation (Evals) 16  
LLM-as-Judge 17  
Hallucination 17  
Grounding 18  
Guardrails 18  
1.7 Plumbing 18  
Observability and Tracing 18  
Model Context Protocol (MCP) 19  
Agents SDK 19  
The Map, Assembled 20  
Chapter 2: What Enterprises Are Building 21  
2.1 The Shift From Pilots to Production 21  
2.2 Where the Value Is Actually Landing 22  
2.3 The Patterns That Are Working 23  
2.4 What Is Failing (and Why) 24  
2.5 What This Means for Your Roadmap 25  
Chapter 3: Models: How to Choose 26  
3.1 There Is No Best Model 26  
3.2 The Dimensions That Actually Matter 27  
3.3 A Decision Framework That Works 28  
3.4 Reasoning Models: A Different Kind of Tool 29  
3.5 Open vs Closed 30  
3.6 Your Evals Beat Any Benchmark 30  
Part 2: Designing AI Products 31  
Chapter 4: Problem-First Design, Revisited 32  
4.1 Why Problem-First Matters More in AI 32  
4.2 The Four Layers Framework 33  
4.3 Six Traps We See Constantly 34  
4.4 A Scoping Template You Can Use 35  
4.5 Designing for Iteration 36  
4.6 Problem-First Doesn't Mean Problem-Forever 37

Chapter 5: Prompting and Context Engineering 38  
5.1 The Six Parts of a Working Prompt . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   
5.2 Prompting for Reasoning Models Is Different 39  
5.3 Context Engineering: The Bigger Picture 40  
5.4 Few-Shot Examples: Your Highest-Leverage Tool 41  
5.5 Output Format: The Interface Nobody Talks About 42  
5.6 When to Stop Iterating on Prompts 42   
Part 3: The Evaluation Core 43   
Chapter 6: Why Evals Are the Real Work 44  
6.1 The 80/20 Flip 44  
6.2 What Evals Actually Buy You 45  
6.3 The Two Questions Every Eval Answers 46  
6.4 Evals Are Infrastructure, Not a Milestone 46  
6.5 A Companion Course 47  
6.6 How to Read the Next Three Chapters 47   
Chapter 7: Code-Based Evals 49  
7.1 What Code-Based Evals Can Check 49  
7.2 When Code-Based Evals Are Enough 50  
7.3 Building Your First Code-Based Eval 51  
7.4 The Failure Modes Code-Based Evals Catch Best 52  
7.5 The Limits 52  
7.6 What You Need in Your First Eval Suite 53   
Chapter 8: LLM-as-Judge and Calibration 54  
8.1 When LLM-as-Judge Makes Sense 54  
8.2 A Brand Voice Judge: A Worked Example 55  
8.3 Writing a Judge Prompt That Works 55  
8.4 Calibration: The Step Nobody Skips Twice 57  
8.5 The Ways LLM Judges Fail 58  
8.6 Judges as Part of a Full Eval Suite 58  
8.7 When to Recalibrate 59   
Chapter 9: Guardrails: Input and Output 60  
9.1 What Guardrails Are 60  
9.2 Input Guardrails 61  
9.3 Output Guardrails 61  
9.4 When Guardrails Replace Evals, and When They Supplement 62  
9.5 The Strictness Tradeoff 63  
9.6 Production Patterns That Work 64

9.7 The Right-Sized Guardrail Stack 64   
Part 4: Building Agentic Systems 65   
Chapter 10: From Single Calls to Agents 66   
10.1 The Spectrum 66   
10.2 Why the Spectrum Matters 67   
10.3 A Simple Rule for Moving Up 68   
10.4 When Agents Are Actually the Right Shape 69   
10.5 The Hybrid Pattern That Usually Wins 69   
10.6 Evaluating Systems as You Move Up 70   
Chapter 11: Workflow and Router Patterns 71   
11.1 The Five Workflow Patterns Worth Knowing 71   
11.2 The Router Pattern in Depth 72   
11.3 Designing a Router That Holds Up 73   
11.4 When to Add Confidence and Human Review 74   
11.5 Human-in-the-Loop Patterns 75   
11.6 Workflow Composability 75   
11.7 The Workflow Shape That Works for Document-Heavy Use Cases 76   
Chapter 12: Tool Use and Actions 78   
12.1 How Tool Use Actually Works 78   
12.2 Designing a Good Tool 79   
12.3 Read-Only Tools First 80   
12.4 Permissioning: The Part Teams Skip 81   
12.5 Error Handling When Tools Fail 81   
12.6 A Reference Tool-Use Shape 82   
12.7 When to Add a New Tool 83   
Chapter 13: Retrieval 84   
13.1 What Retrieval Actually Does 84   
13.2 Semantic Search, Keyword Search, and Why You Usually Want Both 85   
13.3 Chunking: The Decision Most Teams Get Wrong 86   
13.4 Ranking and Reranking 87   
13.5 Evaluating Retrieval 87   
13.6 Retrieval Patterns Beyond the Basics 88   
13.7 What to Do Before Shipping a Retrieval System 89   
Chapter 14: Memory and Long-Running Agents 90   
14.1 Short-Term and Long-Term Memory 90

14.2 When Memory Is Worth Adding . . . . . . . . . . . . . . . . . . . 91
14.3 Short-Term Memory Patterns . . . . . . . . . . . . . . . . . 92
14.4 Long-Term Memory: The Building Blocks . . . . . . . . . . . . . 92
14.5 Memory Evaluations . . . . . . . . . . . . . . . . 93
14.6 Long-Running Agents . . . . . . . . . . . . . . 94
14.7 Memory Gotchas Worth Knowing . . . . . . . . . . . 95

Chapter 15: Multi-Agent Systems 96
15.1 Before You Build a Multi-Agent System, Don't 96
15.2 When Multi-Agent Is Actually the Right Shape 97
15.3 The Main Multi-Agent Topologies 98
15.4 Communication Between Agents 98
15.5 Failure Modes You Should Expect 99
15.6 Evaluating Multi-Agent Systems 100
15.7 One Real Example: The Google AI Co-Scientist 100
15.8 The Honest Short Answer 101

Part 5: Production and the Long Arc 101

Chapter 16: Observability and Tracing 102
16.1 What Observability Looks Like for AI Systems 102
16.2 Why Traces Matter 103
16.3 What to Log (and What Not To) 104
16.4 The Metrics That Matter 104
16.5 From Traces to Evals and Improvements 105
16.6 The Minimum Observability Setup 106
16.7 The Part Nobody Talks About: Culture 106

Chapter 17: Protocols and Extensibility 108
17.1 Why Protocols Matter for Enterprise 108
17.2 Model Context Protocol (MCP) 109
17.3 Agent Protocols (A2A and Similar) 110
17.4 OpenAI Agents SDK 111
17.5 What to Do With All This 111
17.6 Making Your Own System Extensible 112
17.7 The Horizon for Protocols 113

Chapter 18: Production Readiness Checklist 114
18.1 The Core Principle 114
18.2 Pre-Launch Checklist 115
Problem and Scope 115
Evals 115
...
User Experience 116
Documentation 117
18.3 Post-Launch Checklist 117
Weekly 117
Monthly 117
Quarterly 118
Annually 118
18.4 The Signals You Are Drifting 119
18.5 A Word on Shipping Imperfect Systems 119

Part 6: Where to Go Next 120

Chapter 19: Role-Based Learning Tracks 121
19.1 Product Manager Track 121
19.2 UX Designer Track 122
19.3 Engineer Track 124
19.4 Shared Homework Across All Tracks 125
19.5 For Leaders Reading This 125

Chapter 20: The Horizon 127
20.1 Reasoning Keeps Getting Better and Cheaper 127
20.2 Long Context, Really 128
20.3 Multimodal by Default 128
20.4 Open Models Close More of the Gap 129
20.5 Autonomy, Carefully 129
20.6 Regulation and Governance 130
20.7 The Enterprise AI Platform 131
20.8 What Does Not Change 131
20.9 What to Do With This Chapter 132
20.10 Final Word 132

Master Resource Index 134
By Source 134
LevelUp Labs 134
Anthropic 135
OpenAI 135
Google and Google DeepMind 136
Meta 136
DeepLearning.AI 136

Observability Platforms 136  
Retrieval and Vector Databases 137  
Frameworks and Agent Tooling 137  
Guardrail Tools 137  
Protocols 138  
Enterprise AI Reports 138  
Regulation and Governance 138  
Product and Design References 138  
Benchmarks and Model Comparison 138  
By Topic 139  
Foundations and Vocabulary 139  
Enterprise Landscape 139  
Model Selection 139  
Problem-First Design 139  
Prompting and Context Engineering 139  
Evaluation 140  
Guardrails 140  
Agents and Workflows 140  
Tool Use 140  
Retrieval 141  
Memory 141  
Multi-Agent 141  
Observability 141  
Protocols 142  
Regulation and Governance 142  
By Type 142  
Free Courses 142  
Provider Documentation Starting Points 142  
Industry Reports (Annual or Ongoing) 143  
Newsletters and Ongoing Sources 143
...
Go deeper: Andrew Ng's free DeepLearning.AI course Generative AI for Everyone is the cleanest non-technical introduction. For an applied view, start with Module 1 of LevelUp Labs' Generative AI Genius free course.
...
Go deeper: Stanford's paper On the Opportunities and Risks of Foundation Models is the definitional reference. Long, but the first twenty pages are the most cited definition in the field.
...
Go deeper: Anthropic's research post Mapping the Mind of a Large Language Model is the most accessible serious read on what is actually happening inside these systems. Stephen Wolfram's What Is ChatGPT Doing and Why Does It Work is the most useful longer explainer.
...
Go deeper: OpenAI's interactive Tokenizer tool is worth five minutes. Paste in a page of your own content and watch how it splits.
...
Go deeper: The original research paper, Lost in the Middle: How Language Models Use Long Contexts. Anthropic's long context prompting guidance is the best applied reference for getting more out of long windows.
...
Go deeper: The InstructGPT paper from OpenAI is the foundational read on instruction tuning and RLHF. For a more applied view of when fine-tuning is worth it, see LevelUp Labs' Fine-Tuning 101 guide.
...
Go deeper: Wei et al., Chain-of-Thought Prompting Elicits Reasoning in Large Language Models. A short paper, worth reading in full.
...
Go deeper: OpenAI's Learning to Reason with LLMs, Anthropic's Extended Thinking documentation, and the DeepSeek-R1 paper DeepSeek-R1: Incentivizing Reasoning Capability in LLMs.
...
Go deeper: LevelUp Labs' Introduction to Multimodal LLMs guide. For primary sources, see the Gemini technical report and Anthropic's vision documentation.
...
Go deeper: Anthropic's Prompt Engineering guide and OpenAI's Prompting guide are the two best provider-authored references. For a structured course, Week 2 of LevelUp Labs' Applied LLMs Mastery walks through the full taxonomy.
...
Go deeper: Anthropic's system prompts guide.
...
Go deeper: The original GPT-3 paper, Language Models are Few-Shot Learners, introduced the term. For applied patterns, Anthropic's multi-shot prompting guide.
...
Go deeper: Anthropic's tool use documentation and OpenAI's function calling guide.
...
Go deeper: Anthropic's Building Effective Agents is the definitional essay. Read it twice. Also see LevelUp Labs' Agents 101 guide for a structured walk-through.
...
Go deeper: The distinction is made explicit in Building Effective Agents.  
...
Go deeper: Anthropic's Building Effective Agents calls this “routing” as one of five core workflow patterns.
...
Go deeper: Anthropic's How we built our multi-agent research system is the most honest writeup of the tradeoffs. The Google AI Co-Scientist paper, Towards an AI co-scientist, is a good example of a serious production multi-agent system.
...
Go deeper: LevelUp Labs' 3-day RAG roadmap is the best fast path into the topic.
...
Go deeper: OpenAI's embeddings guide is the cleanest applied reference. For the research origins, see the Sentence-BERT paper.
...
Go deeper: The pgvector documentation is worth reading even if you are not using Postgres, because it explains the core concepts cleanly.
...
Go deeper: Anthropic's memory tool documentation and LangChain's memory concepts.

The Ground Truth image displays a single, solid horizontal line. According to Rule 2 (UNDERSCORE & LINE RULES), if the GT contains lines used for stylistic emphasis or as background (like ruled paper), the OCR result must ignore them. The OCR content provided is "\_\_\_\_", which consists of four underscores. This is incorrect because underscores are not equivalent to a solid line and are not permitted under the “Stylistic/Background Lines (Ignore)” rule. The OCR has hallucinated underscores where none should exist in the GT, violating the rule to ignore stylistic lines. Therefore, the OCR result is inconsistent with the Ground Truth.
...
Go deeper: Part 3 of this guide goes deep on each eval type. For the full mechanics with worked examples, AI Evals for Everyone is our companion course on this ground.
...
Go deeper: The foundational paper is Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena. For applied guidance, our AI Evals for Everyone course has a dedicated module.
...
Go deeper: OpenAI's research post Why language models hallucinate is a solid primer.
...
Go deeper: Google's Vertex AI grounding documentation and Anthropic's citations documentation both cover applied grounding patterns.
...
Go deeper: NVIDIA's NeMo Guardrails documentation, Meta's Llama Guard, and Microsoft's Presidio are the three most useful references.
...
Go deeper: Arize Phoenix and LangSmith are the two most common platforms. For open standards, see OpenTelemetry's GenAI semantic conventions.
...
Go deeper: The MCP specification and Anthropic's Introducing the Model Context Protocol announcement are the starting points.
...
Go deeper: The OpenAI Agents SDK documentation and LangGraph's documentation are the two most mature references.
...
Go deeper: McKinsey's State of AI survey (published annually) and Menlo Ventures' perspectives (they publish an annual State of AI in the Enterprise report).
...
Go deeper: Anthropic's Economic Index covers how Claude is being used across industries in aggregate. OpenAI publishes customer stories that are useful for shape-of-production reference.
...
Go deeper: Anthropic's Building Effective Agents is the clearest public articulation of the workflow-before-agent argument. The a16z Enterprise AI report has good sector-by-sector pattern breakdowns.
...
Go deeper: Stanford's HELM project is the most serious public benchmarking effort and is worth bookmarking. LMArena (crowdsourced head-to-head comparisons) is a useful directional signal.
...
Go deeper: Each provider publishes a model comparison matrix. Anthropic's model selection guide, OpenAI's model documentation, and Google's Gemini model card are the primary sources. For open models, Hugging Face's leaderboard is the standard reference.
...
Go deeper: Anthropic's When to use Claude Opus 4 vs Claude Sonnet 4 post has useful guidance. OpenAI's reasoning guide explains when o-series models are worth the cost.
...
Go deeper: OpenAI's research post Learning to Reason with LLMs and DeepSeek's paper DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning are the two most useful public accounts of how reasoning models work.
...
Go deeper: Meta's Llama research page. Hugging Face's open leaderboard. Together AI, Fireworks, and Groq documentation for hosted-open options.
...
Go deeper: Anthropic's Building Effective Agents opens with the same thesis: “When building with LLMs, we recommend finding the simplest solution possible, and only increasing complexity when needed.”
...
Go deeper: Marty Cagan's product discovery framework is the parent idea. Anthropic's engineering blog has several applied writeups that follow a similar shape.
...
Go deeper: McKinsey's State of AI reports cover these patterns with industry data, and Anthropic's engineering blog has multiple writeups on the “start with the simplest solution” principle.
...
Go deeper: Shreyas Doshi's writing on product iteration loops is useful background on shipping iteratively.
...
Go deeper: Anthropic's Prompt Engineering Overview walks through each of these. OpenAI's Prompt Engineering guide is a good companion read.
...
Go deeper: OpenAI's Reasoning Guide and Anthropic's Extended Thinking documentation are the primary references.
...
Go deeper: Anthropic's engineering post Effective Context Engineering for AI Agents is the clearest public writeup on this topic. LangChain's context engineering guide is a good applied companion.
...
Go deeper: Anthropic's multi-shot prompting guide covers the mechanics. LevelUp Labs' Applied LLMs Mastery Week 2 covers the full prompting taxonomy with examples.
...
Go deeper: Anthropic's structured output documentation and OpenAI's structured outputs guide are the two primary references.
...
Go deeper: Anthropic's prompt engineering overview has a short section on when to move past prompting. The next chapter of this guide (Why Evals Are the Real Work) gives you the framework for knowing when you have hit the ceiling in the first place.
...
Go deeper: The Arize Phoenix documentation on code-based evals walks through common patterns. LangSmith's evaluation guide covers similar ground with a slightly different framing.
...
Go deeper: Arize Phoenix, LangSmith, and Promptfoo are the three most common choices. For a PM-friendly writeup, OpenAI's evals guide walks through the core concepts.
...
Go deeper: Anthropic's evaluation guide covers judge-style prompting. Arize's blog post Evaluating LLMs with LLMs is a good applied companion.
...
Go deeper: The full calibration workflow is covered end-to-end in AI Evals for Everyone with worked examples on real datasets.
...
\- Action boundary enforcement, for any system with tools that can take actions
...
Go deeper: NVIDIA NeMo Guardrails is the leading open-source framework. Lakera Guard, Prompt Armor, and Microsoft Presidio are solid commercial options for specific guardrail categories.
...
Go deeper: Anthropic's Building Effective Agents is the single best public writeup on this topic. Read it end to end. LevelUp Labs' Agents 101 guide is a solid shorter primer.
...
Go deeper: Anthropic's Building Effective Agents is the clearest writeup of these five patterns with diagrams and code examples. Every product team should read it once.
...
Go deeper: LangGraph's human-in-the-loop documentation walks through the mechanics in code. Anthropic's engineering blog has posts on production agent patterns worth browsing.
...
Go deeper: Anthropic's Tool Use documentation and OpenAI's Function Calling guide are the two primary references. Both walk through the mechanics with code examples.
...
Go deeper: The Arize blog post The Essential Guide to Tool Use covers the end-to-end pattern. LevelUp Labs' Agents 101 guide has a section on tool-using agents that complements this chapter well.
...
Go deeper: LevelUp Labs' 3-day RAG roadmap is the fastest way to get the full shape. For a provider's applied guide, Anthropic's Contextual Retrieval post is worth the read.
...
Go deeper: Pinecone's Hybrid Search explainer and Weaviate's Hybrid Search documentation cover this well. OpenAI's embeddings guide is the best applied starting point for semantic search.
...
Go deeper: Cohere's Rerank documentation explains the concept well. Pinecone's blog on reranking has good applied examples.
...
Go deeper: Microsoft GraphRAG documentation for the graph approach. Anthropic's prompt caching documentation for caching patterns. LlamaIndex's advanced retrieval documentation is a good overview of the state of the art.
...
Personalization over time. The user's preferences change the system's behavior meaningfully. A writing assistant that remembers the user's voice. A research agent that remembers which sources the user trusts.
...
Go deeper: Anthropic's Memory Tool documentation shows their recommended pattern. LangGraph's memory documentation walks through the building blocks. Letta (formerly MemGPT) is the most mature open-source memory system and a good reference implementation.
...
Go deeper: LangGraph's long-running agents documentation covers checkpointing well. OpenAI's Agents SDK documentation includes long-running patterns.
...
Go deeper: Anthropic's writeup How we built our multi-agent research system is the most honest public account of the tradeoffs. They explicitly note that the multi-agent approach paid off for research but would be overkill for simpler tasks.
...
Go deeper: Anthropic's multi-agent research system writeup covers several of these in the “what we learned” section.
...
Go deeper: Google DeepMind's AI Co-Scientist blog post.
...
Go deeper: Arize Phoenix and LangSmith are the two widely adopted options. Both are free to start.
...
Go deeper: OpenTelemetry's GenAI semantic conventions are the emerging open standard for how AI traces should be structured. Useful to know about even if you are using a commercial platform.
...
Go deeper: Arize Phoenix Quickstart gets you tracing in under an hour. LangSmith's observability quickstart is the equivalent for the LangChain ecosystem.
...
Go deeper: MCP specification and documentation is the primary reference. Anthropic's announcement post Introducing the Model Context Protocol is the best short introduction.
...
Go deeper: OpenAI Agents SDK documentation. LangGraph's multi-agent documentation covers the same ideas in a different framework.
...
Go deeper: EU AI Act summary for the legal shape. NIST AI Risk Management Framework for a widely-cited US reference.
...
Every external resource referenced across the twenty chapters, organized three ways: by source, by topic, and by type of resource.

Use this as your starting point when you want to go deeper on a specific topic or when you are trying to find that one link you remember reading about in Chapter 11.

## By Source

## LevelUp Labs

The most important single source for this guide. Free, actively maintained, built for practitioners.

\- awesome-generative-ai-guide: the main repo. Paper roundups, free courses, interview prep.

\- AI Evals for Everyone: LevelUp Labs' companion course on evaluation. Threaded throughout Part 3 of this guide.

\- Generative AI Genius: LevelUp Labs' free course on building generative AI applications end to end.

\- Applied LLMs Mastery 2024: 10-week course on LLM applications, foundations through deployment.
...
The clearest applied writing in the field from a model provider.

• Building Effective Agents: referenced repeatedly. Read end to end.
...
\- Learning to Reason with LLMs: OpenAI's post on o-series reasoning
...
\- Llama Guard research

## DeepLearning.AI

Andrew Ng's free learning platform. The cleanest, most accessible technical education in AI.

\- Generative AI for Everyone: best non-technical intro

\- DeepLearning.AI Short Courses: 60+ free short courses on specific AI topics, many co-taught with Anthropic, OpenAI, and other providers

## Observability Platforms

\- Arize Phoenix: widely adopted observability platform

• Arize Phoenix Quickstart
...
\- OpenTelemetry GenAI semantic conventions: the emerging open standard
...
\- Letta: open-source memory system (formerly MemGPT)
...
\- Lakera Guard: prompt injection and jailbreak detection
...
• Menlo Ventures State of AI in the Enterprise
...
\- HELM: Stanford's benchmarking effort

• LMArena: crowdsourced head-to-head model comparisons
...
\- LevelUp Labs' awesome-generative-ai-guide

\- DeepLearning.AI's Generative AI for Everyone

• LevelUp Labs' Generative AI Genius
...
\- Provider model pages (Anthropic, OpenAI, Google, Meta)
...
\- LevelUp Labs' Applied LLMs Mastery Week 2

## Evaluation

\- LevelUp's AI Evals for Everyone: the headline recommendation
...
• Building Effective Agents: the single best reference

• LevelUp Labs' Agents 101 guide
...
• LevelUp Labs' 3-day RAG roadmap
...
• AI Evals for Everyone: LevelUp, strongly recommended

• Generative AI Genius: LevelUp

• Applied LLMs Mastery 2024: LevelUp

\- Generative AI for Everyone: DeepLearning.AI, non-technical

\- DeepLearning.AI Short Courses: 60+ courses on specific topics

## Provider Documentation Starting Points
...
## Industry Reports (Annual or Ongoing)
...
\- LevelUp Labs' monthly paper roundup in awesome-generative-ai-guide

\- Anthropic Engineering Blog (anthropic.com/engineering)

\- OpenAI Research (openai.com/research, openai.com/index)
